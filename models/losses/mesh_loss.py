...
class MeshLoss(nn.Module):
    ...
    def joints_3d_loss(self, pred_joints_3d, gt_joints_3d, joints_3d_visible):
        """Compute 3D joints loss for the output that 3D joint annotations
        are available.
    ...
    def vertex_loss(self, pred_vertices, gt_vertices, has_smpl):
        """Compute 3D vertex loss for the output that 3D human mesh
    ...
    def smpl_losses(self, pred_rotmat, pred_betas, gt_pose, gt_betas,
                    has_smpl):
        """Compute SMPL parameters loss for the output that SMPL parameter
        annotations are available.
